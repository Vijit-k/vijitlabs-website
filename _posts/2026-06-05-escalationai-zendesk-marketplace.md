...
cta_text: "EscalationAI is available now as a private Zendesk app while the marketplace listing is under review. Reach out to set it up for your team."
...
- **Support managers** who want visibility into risk across the queue without reading every ticket
- **Team leads** who handle escalation reviews and need documentation of why a ticket was flagged
- **Zendesk admins** at companies with compliance requirements around AI-assisted tools
...
EscalationAI is built by [Vijit Labs](https://vijitlabs.com). If you have questions about how it works, the ISO 42001 alignment, or the private app installation process, the contact details are on the product page.
